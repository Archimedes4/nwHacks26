  ...
  return (
    <ScrollView style={{width, height, backgroundColor: Colors.primary}}>
      ...
      <View style={{width, height, position: 'absolute'}}>
        ...
        <Text style={{color: Colors.light, fontFamily: "Playpen", fontSize: 30, marginHorizontal: 'auto', marginBottom: 25, marginTop: 15}}>We&apos;re here to help you fix your sleep!</Text>
        <View style={{flexDirection: 'row'}}>
          <View style={{marginHorizontal: 'auto'}}>
            <AdviceIcon width={height * 0.2} height={height * 0.2} color={Colors.light}/>
            <Text style={{color: Colors.light, fontFamily: "Playpen", fontSize: 20, flexDirection: 'row'}}>Sleep Advice</Text>
          </View>
          <View>
            <SleepIcon width={height * 0.2} height={height * 0.2} color={Colors.light} />
            <Text style={{color: Colors.light, fontFamily: "Playpen", fontSize: 20, flexDirection: 'row'}}>Sleep Tracking</Text>
          </View>
          <View style={{marginHorizontal: 'auto'}}>
            <TVIcon width={height * 0.2} height={height * 0.2} color={Colors.light} />
            <Text style={{color: Colors.light, fontFamily: "Playpen", fontSize: 20, flexDirection: 'row'}}>Sleep Content</Text>
          </View>
        </View>
        <Text style={{color: Colors.light, fontFamily: "Playpen", fontSize: 30, marginHorizontal: "auto", marginTop: height * 0.05, marginBottom: height * 0.025}}>Why choose Somnia</Text>
